...
console.log("orderorderorderorderorder",JSON.stringify(order))
  // console.log(product)
  ...
  return (
    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      {Array.isArray(allorder.cartItems) ? (
        // Handle the case where cartItems is an array
            ...
            <tbody key={item.id}>
              ...
              >
                ...
                <th
                  ...
                  className="px-6 py-4 font-medium text-black whitespace-nowrap"
                >
                  {imageUrl && <img className="w-16" src={imageUrl} alt="img" />}
                </th>
                <td
                  className="px-6 py-4 text-black "
                  style={{
        ...
        // Handle the case where cartItems is an object
        <tbody key={allorder.cartItems.id}>
          <tr
            className="bg-gray-50 border-b  dark:border-gray-700"
            style={{
              backgroundColor: mode === "dark" ? "rgb(46 49 55)" : "",
          ...
          >
            ...
            <th
              ...
              className="px-6 py-4 font-medium text-black whitespace-nowrap"
            >
              {allorder.cartItems.items[0].imageUrl && (
                <img
                  className="w-16"
                  src={allorder.cartItems.items[0].imageUrl}
                  alt="img"
                />
              )}
            </th>
            ...
            >
              {allorder.cartItems.items[0].title}
            </td>
            <td
              className="px-6 py-4 text-black "
              style={{
            ...
            >
              ₹{allorder.cartItems.items[0].price}
            </td>
            <td
              className="px-6 py-4 text-black "
              style={{
            ...
            >
              {allorder.cartItems.items[0].category}
            </td>
            <td
              className="px-6 py-4 text-black "
              style={{
